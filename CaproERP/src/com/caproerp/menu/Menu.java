package com.caproerp.menu;

import com.caproerp.menu.mode.LightDarkMode;
...
import com.caproerp.menu.mode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"Dashboard"},
        {"~MAIN MENU~"},
        {"Inventory", "Sales", "Sales Return", "Purchase", "Purchase Return", "Payments"},
<<<<<<< HEAD
        {"Product Details", "Products","Brands","Category"},
        {"Ledger Details", "Party", "Route"},
=======
        {"Product Details", "Products","Brands","Unit Types"},
        {"Ledger"},
        {"Employees"},
        {"Expenses"},
>>>>>>> 1bfef153545430d2905e89aedf1afa7591b96837
        {"~COMPONENT~"},
    ...
    private void init() {
        ...
        header.setIcon(new ImageIcon(getClass().getResource("/com/caproerp/icon/png/logo.png")));
