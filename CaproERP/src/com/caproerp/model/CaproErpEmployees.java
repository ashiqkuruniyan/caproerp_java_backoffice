...
@NamedQueries({
    @NamedQuery(name = "CaproErpEmployees.findAll", query = "SELECT c FROM CaproErpEmployees c"),
    @NamedQuery(name = "CaproErpEmployees.findByEmployeeId", query = "SELECT c FROM CaproErpEmployees c WHERE c.employeeId = :employeeId"),
    @NamedQuery(name = "CaproErpEmployees.findByEmployeeCode", query = "SELECT c FROM CaproErpEmployees c WHERE c.employeeCode = :employeeCode"),
    @NamedQuery(name = "CaproErpEmployees.findByEmployeeName", query = "SELECT c FROM CaproErpEmployees c WHERE c.employeeName = :employeeName"),
    @NamedQuery(name = "CaproErpEmployees.findByEmployeeNameLocal", query = "SELECT c FROM CaproErpEmployees c WHERE c.employeeNameLocal = :employeeNameLocal"),
    @NamedQuery(name = "CaproErpEmployees.findByEmployeeDob", query = "SELECT c FROM CaproErpEmployees c WHERE c.employeeDob = :employeeDob"),
    @NamedQuery(name = "CaproErpEmployees.findByEmployeeContactNo", query = "SELECT c FROM CaproErpEmployees c WHERE c.employeeContactNo = :employeeContactNo"),
    @NamedQuery(name = "CaproErpEmployees.findByEmployeeWhatsappNo", query = "SELECT c FROM CaproErpEmployees c WHERE c.employeeWhatsappNo = :employeeWhatsappNo"),
    @NamedQuery(name = "CaproErpEmployees.findByRegContactNo", query = "SELECT c FROM CaproErpEmployees c WHERE c.regContactNo = :regContactNo"),
    @NamedQuery(name = "CaproErpEmployees.findByEmployeeCountryCode", query = "SELECT c FROM CaproErpEmployees c WHERE c.employeeCountryCode = :employeeCountryCode"),
    @NamedQuery(name = "CaproErpEmployees.findByEmployeeEmail", query = "SELECT c FROM CaproErpEmployees c WHERE c.employeeEmail = :employeeEmail"),
    @NamedQuery(name = "CaproErpEmployees.findByEmployeeLocation", query = "SELECT c FROM CaproErpEmployees c WHERE c.employeeLocation = :employeeLocation"),
    @NamedQuery(name = "CaproErpEmployees.findByEmployeeLatitude", query = "SELECT c FROM CaproErpEmployees c WHERE c.employeeLatitude = :employeeLatitude"),
    @NamedQuery(name = "CaproErpEmployees.findByEmployeeLongitude", query = "SELECT c FROM CaproErpEmployees c WHERE c.employeeLongitude = :employeeLongitude"),
    @NamedQuery(name = "CaproErpEmployees.findByEmployeeAddress", query = "SELECT c FROM CaproErpEmployees c WHERE c.employeeAddress = :employeeAddress"),
    @NamedQuery(name = "CaproErpEmployees.findByCountryName", query = "SELECT c FROM CaproErpEmployees c WHERE c.countryName = :countryName"),
    @NamedQuery(name = "CaproErpEmployees.findByStateName", query = "SELECT c FROM CaproErpEmployees c WHERE c.stateName = :stateName"),
    @NamedQuery(name = "CaproErpEmployees.findByCurrencyCode", query = "SELECT c FROM CaproErpEmployees c WHERE c.currencyCode = :currencyCode"),
    @NamedQuery(name = "CaproErpEmployees.findByWorkStartTime", query = "SELECT c FROM CaproErpEmployees c WHERE c.workStartTime = :workStartTime"),
    @NamedQuery(name = "CaproErpEmployees.findByWorkEndTime", query = "SELECT c FROM CaproErpEmployees c WHERE c.workEndTime = :workEndTime"),
    @NamedQuery(name = "CaproErpEmployees.findByBaseSalary", query = "SELECT c FROM CaproErpEmployees c WHERE c.baseSalary = :baseSalary"),
    @NamedQuery(name = "CaproErpEmployees.findByCapitalAmount", query = "SELECT c FROM CaproErpEmployees c WHERE c.capitalAmount = :capitalAmount"),
    @NamedQuery(name = "CaproErpEmployees.findByPremiumStartDate", query = "SELECT c FROM CaproErpEmployees c WHERE c.premiumStartDate = :premiumStartDate"),
    @NamedQuery(name = "CaproErpEmployees.findByPremiumEndDate", query = "SELECT c FROM CaproErpEmployees c WHERE c.premiumEndDate = :premiumEndDate"),
    @NamedQuery(name = "CaproErpEmployees.findByLoginType", query = "SELECT c FROM CaproErpEmployees c WHERE c.loginType = :loginType"),
    @NamedQuery(name = "CaproErpEmployees.findByDefaultPrinter", query = "SELECT c FROM CaproErpEmployees c WHERE c.defaultPrinter = :defaultPrinter"),
    @NamedQuery(name = "CaproErpEmployees.findByPrintType", query = "SELECT c FROM CaproErpEmployees c WHERE c.printType = :printType"),
    @NamedQuery(name = "CaproErpEmployees.findByPrintBillAs", query = "SELECT c FROM CaproErpEmployees c WHERE c.printBillAs = :printBillAs"),
    @NamedQuery(name = "CaproErpEmployees.findByAccessPermission", query = "SELECT c FROM CaproErpEmployees c WHERE c.accessPermission = :accessPermission"),
    @NamedQuery(name = "CaproErpEmployees.findByPrinterHeader", query = "SELECT c FROM CaproErpEmployees c WHERE c.printerHeader = :printerHeader"),
    @NamedQuery(name = "CaproErpEmployees.findByPrinterHeaderSalesText", query = "SELECT c FROM CaproErpEmployees c WHERE c.printerHeaderSalesText = :printerHeaderSalesText"),
    @NamedQuery(name = "CaproErpEmployees.findByPrinterHeaderSalesReturnText", query = "SELECT c FROM CaproErpEmployees c WHERE c.printerHeaderSalesReturnText = :printerHeaderSalesReturnText"),
    @NamedQuery(name = "CaproErpEmployees.findByPrinterHeaderPurchaseText", query = "SELECT c FROM CaproErpEmployees c WHERE c.printerHeaderPurchaseText = :printerHeaderPurchaseText"),
    @NamedQuery(name = "CaproErpEmployees.findByPrinterHeaderPurchaseReturnText", query = "SELECT c FROM CaproErpEmployees c WHERE c.printerHeaderPurchaseReturnText = :printerHeaderPurchaseReturnText"),
    @NamedQuery(name = "CaproErpEmployees.findByTaxInWords", query = "SELECT c FROM CaproErpEmployees c WHERE c.taxInWords = :taxInWords"),
    @NamedQuery(name = "CaproErpEmployees.findByNeedQtyEnterDialog", query = "SELECT c FROM CaproErpEmployees c WHERE c.needQtyEnterDialog = :needQtyEnterDialog"),
    @NamedQuery(name = "CaproErpEmployees.findByDecimalFormat", query = "SELECT c FROM CaproErpEmployees c WHERE c.decimalFormat = :decimalFormat"),
    @NamedQuery(name = "CaproErpEmployees.findByPartyLastPrice", query = "SELECT c FROM CaproErpEmployees c WHERE c.partyLastPrice = :partyLastPrice"),
    @NamedQuery(name = "CaproErpEmployees.findByPartyPriceType", query = "SELECT c FROM CaproErpEmployees c WHERE c.partyPriceType = :partyPriceType"),
    @NamedQuery(name = "CaproErpEmployees.findByPartyWiseTax", query = "SELECT c FROM CaproErpEmployees c WHERE c.partyWiseTax = :partyWiseTax"),
    @NamedQuery(name = "CaproErpEmployees.findByAutoTranslation", query = "SELECT c FROM CaproErpEmployees c WHERE c.autoTranslation = :autoTranslation"),
    @NamedQuery(name = "CaproErpEmployees.findByProductType", query = "SELECT c FROM CaproErpEmployees c WHERE c.productType = :productType"),
    @NamedQuery(name = "CaproErpEmployees.findByMultiUnit", query = "SELECT c FROM CaproErpEmployees c WHERE c.multiUnit = :multiUnit"),
    @NamedQuery(name = "CaproErpEmployees.findByTaxCutOption", query = "SELECT c FROM CaproErpEmployees c WHERE c.taxCutOption = :taxCutOption"),
    @NamedQuery(name = "CaproErpEmployees.findByScanAndBill", query = "SELECT c FROM CaproErpEmployees c WHERE c.scanAndBill = :scanAndBill"),
    @NamedQuery(name = "CaproErpEmployees.findByPartyBalanceInPrint", query = "SELECT c FROM CaproErpEmployees c WHERE c.partyBalanceInPrint = :partyBalanceInPrint"),
    @NamedQuery(name = "CaproErpEmployees.findByCombinedInvoice", query = "SELECT c FROM CaproErpEmployees c WHERE c.combinedInvoice = :combinedInvoice"),
    @NamedQuery(name = "CaproErpEmployees.findByGlobalTaxType", query = "SELECT c FROM CaproErpEmployees c WHERE c.globalTaxType = :globalTaxType"),
    @NamedQuery(name = "CaproErpEmployees.findByOfflineBilling", query = "SELECT c FROM CaproErpEmployees c WHERE c.offlineBilling = :offlineBilling"),
    @NamedQuery(name = "CaproErpEmployees.findByFullyOffline", query = "SELECT c FROM CaproErpEmployees c WHERE c.fullyOffline = :fullyOffline"),
    @NamedQuery(name = "CaproErpEmployees.findByAutoSyncing", query = "SELECT c FROM CaproErpEmployees c WHERE c.autoSyncing = :autoSyncing"),
    @NamedQuery(name = "CaproErpEmployees.findByDiscountOption", query = "SELECT c FROM CaproErpEmployees c WHERE c.discountOption = :discountOption"),
    @NamedQuery(name = "CaproErpEmployees.findByMaximumDiscountOption", query = "SELECT c FROM CaproErpEmployees c WHERE c.maximumDiscountOption = :maximumDiscountOption"),
    @NamedQuery(name = "CaproErpEmployees.findByDuplicateProductCart", query = "SELECT c FROM CaproErpEmployees c WHERE c.duplicateProductCart = :duplicateProductCart"),
    @NamedQuery(name = "CaproErpEmployees.findByStockList", query = "SELECT c FROM CaproErpEmployees c WHERE c.stockList = :stockList"),
    @NamedQuery(name = "CaproErpEmployees.findByPriceList", query = "SELECT c FROM CaproErpEmployees c WHERE c.priceList = :priceList"),
    @NamedQuery(name = "CaproErpEmployees.findByDisableReviewReceipt", query = "SELECT c FROM CaproErpEmployees c WHERE c.disableReviewReceipt = :disableReviewReceipt"),
    @NamedQuery(name = "CaproErpEmployees.findByRoundOf", query = "SELECT c FROM CaproErpEmployees c WHERE c.roundOf = :roundOf"),
    @NamedQuery(name = "CaproErpEmployees.findByUpdateCalculatedTotal", query = "SELECT c FROM CaproErpEmployees c WHERE c.updateCalculatedTotal = :updateCalculatedTotal"),
    @NamedQuery(name = "CaproErpEmployees.findByFilterOptions", query = "SELECT c FROM CaproErpEmployees c WHERE c.filterOptions = :filterOptions"),
    @NamedQuery(name = "CaproErpEmployees.findByNeedPaymentGateway", query = "SELECT c FROM CaproErpEmployees c WHERE c.needPaymentGateway = :needPaymentGateway"),
    @NamedQuery(name = "CaproErpEmployees.findBySplitPayment", query = "SELECT c FROM CaproErpEmployees c WHERE c.splitPayment = :splitPayment"),
    @NamedQuery(name = "CaproErpEmployees.findByDeliveryChargeOption", query = "SELECT c FROM CaproErpEmployees c WHERE c.deliveryChargeOption = :deliveryChargeOption"),
    @NamedQuery(name = "CaproErpEmployees.findByDefaultDeliveryCharge", query = "SELECT c FROM CaproErpEmployees c WHERE c.defaultDeliveryCharge = :defaultDeliveryCharge"),
    @NamedQuery(name = "CaproErpEmployees.findByAssignedProducts", query = "SELECT c FROM CaproErpEmployees c WHERE c.assignedProducts = :assignedProducts"),
    @NamedQuery(name = "CaproErpEmployees.findByMakeSales", query = "SELECT c FROM CaproErpEmployees c WHERE c.makeSales = :makeSales"),
    @NamedQuery(name = "CaproErpEmployees.findByMakeSalesReturn", query = "SELECT c FROM CaproErpEmployees c WHERE c.makeSalesReturn = :makeSalesReturn"),
    @NamedQuery(name = "CaproErpEmployees.findByMakePurchase", query = "SELECT c FROM CaproErpEmployees c WHERE c.makePurchase = :makePurchase"),
    @NamedQuery(name = "CaproErpEmployees.findByMakePurchaseReturn", query = "SELECT c FROM CaproErpEmployees c WHERE c.makePurchaseReturn = :makePurchaseReturn"),
    @NamedQuery(name = "CaproErpEmployees.findByMakePayment", query = "SELECT c FROM CaproErpEmployees c WHERE c.makePayment = :makePayment"),
    @NamedQuery(name = "CaproErpEmployees.findByProductsMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.productsMenu = :productsMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByPartyMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.partyMenu = :partyMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByExpenseMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.expenseMenu = :expenseMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByDaybookMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.daybookMenu = :daybookMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByEstimateMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.estimateMenu = :estimateMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByQuotationsMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.quotationsMenu = :quotationsMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByPreOrderMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.preOrderMenu = :preOrderMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByStockInMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.stockInMenu = :stockInMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByStockOutMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.stockOutMenu = :stockOutMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByNotificationsMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.notificationsMenu = :notificationsMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByCapitalMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.capitalMenu = :capitalMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByCategoryMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.categoryMenu = :categoryMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByBrandMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.brandMenu = :brandMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByUnitTypesMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.unitTypesMenu = :unitTypesMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByPartyTypesMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.partyTypesMenu = :partyTypesMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByRoutesMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.routesMenu = :routesMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByStockManagementMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.stockManagementMenu = :stockManagementMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByBalanceManagementMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.balanceManagementMenu = :balanceManagementMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByEmployeesMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.employeesMenu = :employeesMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByBranchesMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.branchesMenu = :branchesMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByScanMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.scanMenu = :scanMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByAttendanceMenu", query = "SELECT c FROM CaproErpEmployees c WHERE c.attendanceMenu = :attendanceMenu"),
    @NamedQuery(name = "CaproErpEmployees.findByAddProduct", query = "SELECT c FROM CaproErpEmployees c WHERE c.addProduct = :addProduct"),
    @NamedQuery(name = "CaproErpEmployees.findByAddParty", query = "SELECT c FROM CaproErpEmployees c WHERE c.addParty = :addParty"),
    @NamedQuery(name = "CaproErpEmployees.findByDeleteSales", query = "SELECT c FROM CaproErpEmployees c WHERE c.deleteSales = :deleteSales"),
    @NamedQuery(name = "CaproErpEmployees.findByDeletePurchase", query = "SELECT c FROM CaproErpEmployees c WHERE c.deletePurchase = :deletePurchase"),
    @NamedQuery(name = "CaproErpEmployees.findByDeletePayment", query = "SELECT c FROM CaproErpEmployees c WHERE c.deletePayment = :deletePayment"),
    @NamedQuery(name = "CaproErpEmployees.findByDeleteProduct", query = "SELECT c FROM CaproErpEmployees c WHERE c.deleteProduct = :deleteProduct"),
    @NamedQuery(name = "CaproErpEmployees.findByDeleteParty", query = "SELECT c FROM CaproErpEmployees c WHERE c.deleteParty = :deleteParty"),
    @NamedQuery(name = "CaproErpEmployees.findByEditSales", query = "SELECT c FROM CaproErpEmployees c WHERE c.editSales = :editSales"),
    @NamedQuery(name = "CaproErpEmployees.findByEditSalesPrice", query = "SELECT c FROM CaproErpEmployees c WHERE c.editSalesPrice = :editSalesPrice"),
    @NamedQuery(name = "CaproErpEmployees.findByEditPurchase", query = "SELECT c FROM CaproErpEmployees c WHERE c.editPurchase = :editPurchase"),
    @NamedQuery(name = "CaproErpEmployees.findByEditPurchasePrice", query = "SELECT c FROM CaproErpEmployees c WHERE c.editPurchasePrice = :editPurchasePrice"),
    @NamedQuery(name = "CaproErpEmployees.findByEditPayment", query = "SELECT c FROM CaproErpEmployees c WHERE c.editPayment = :editPayment"),
    @NamedQuery(name = "CaproErpEmployees.findByEditProduct", query = "SELECT c FROM CaproErpEmployees c WHERE c.editProduct = :editProduct"),
    @NamedQuery(name = "CaproErpEmployees.findByEditParty", query = "SELECT c FROM CaproErpEmployees c WHERE c.editParty = :editParty"),
    @NamedQuery(name = "CaproErpEmployees.findBySalesReturnOption", query = "SELECT c FROM CaproErpEmployees c WHERE c.salesReturnOption = :salesReturnOption"),
    @NamedQuery(name = "CaproErpEmployees.findByPurchaseReturnOption", query = "SELECT c FROM CaproErpEmployees c WHERE c.purchaseReturnOption = :purchaseReturnOption"),
    @NamedQuery(name = "CaproErpEmployees.findByZatcaConfig", query = "SELECT c FROM CaproErpEmployees c WHERE c.zatcaConfig = :zatcaConfig"),
    @NamedQuery(name = "CaproErpEmployees.findByBranchName", query = "SELECT c FROM CaproErpEmployees c WHERE c.branchName = :branchName"),
    @NamedQuery(name = "CaproErpEmployees.findByAdminName", query = "SELECT c FROM CaproErpEmployees c WHERE c.adminName = :adminName"),
    @NamedQuery(name = "CaproErpEmployees.findByUserType", query = "SELECT c FROM CaproErpEmployees c WHERE c.userType = :userType"),
    @NamedQuery(name = "CaproErpEmployees.findByEmployeeStatus", query = "SELECT c FROM CaproErpEmployees c WHERE c.employeeStatus = :employeeStatus"),
    @NamedQuery(name = "CaproErpEmployees.findByAddedUserId", query = "SELECT c FROM CaproErpEmployees c WHERE c.addedUserId = :addedUserId"),
    @NamedQuery(name = "CaproErpEmployees.findByUpdatedUserId", query = "SELECT c FROM CaproErpEmployees c WHERE c.updatedUserId = :updatedUserId"),
    @NamedQuery(name = "CaproErpEmployees.findByAddedIpAddress", query = "SELECT c FROM CaproErpEmployees c WHERE c.addedIpAddress = :addedIpAddress"),
    @NamedQuery(name = "CaproErpEmployees.findByAddedLatitude", query = "SELECT c FROM CaproErpEmployees c WHERE c.addedLatitude = :addedLatitude"),
    @NamedQuery(name = "CaproErpEmployees.findByAddedLongitude", query = "SELECT c FROM CaproErpEmployees c WHERE c.addedLongitude = :addedLongitude"),
    @NamedQuery(name = "CaproErpEmployees.findByAddedDateTime", query = "SELECT c FROM CaproErpEmployees c WHERE c.addedDateTime = :addedDateTime"),
    @NamedQuery(name = "CaproErpEmployees.findByUpdatedIpAddress", query = "SELECT c FROM CaproErpEmployees c WHERE c.updatedIpAddress = :updatedIpAddress"),
    @NamedQuery(name = "CaproErpEmployees.findByUpdatedLatitude", query = "SELECT c FROM CaproErpEmployees c WHERE c.updatedLatitude = :updatedLatitude"),
    @NamedQuery(name = "CaproErpEmployees.findByUpdatedLongitude", query = "SELECT c FROM CaproErpEmployees c WHERE c.updatedLongitude = :updatedLongitude"),
    @NamedQuery(name = "CaproErpEmployees.findByUpdatedDateTime", query = "SELECT c FROM CaproErpEmployees c WHERE c.updatedDateTime = :updatedDateTime")})
public class CaproErpEmployees implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "employeeId")
    private Collection<CaproErpUsers> caproErpUsersCollection;
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "employeeId")
    ...
    public Collection<CaproErpUsers> getCaproErpUsersCollection() {
        return caproErpUsersCollection;
    }

    public void setCaproErpUsersCollection(Collection<CaproErpUsers> caproErpUsersCollection) {
    ...
    public CaproErpCountry getCountryId() {
        return countryId;
    }

    public void setCountryId(CaproErpCountry countryId) {
        this.countryId = countryId;
    }

    public CaproErpRoutes getRouteId() {
        return routeId;
    }

    public void setRouteId(CaproErpRoutes routeId) {
        this.routeId = routeId;
    }

    public CaproErpStates getStateId() {
        return stateId;
    }

    public void setStateId(CaproErpStates stateId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CaproErpEmployees)) {
            return false;
        }
        CaproErpEmployees other = (CaproErpEmployees) object;
    ...
    public String toString() {
        return "com.caproerp.products.model.CaproErpEmployees[ employeeId=" + employeeId + " ]";
    }
