...
@NamedQueries({
    @NamedQuery(name = "CaproErpStates_1.findAll", query = "SELECT c FROM CaproErpStates_1 c"),
    @NamedQuery(name = "CaproErpStates_1.findByStateId", query = "SELECT c FROM CaproErpStates_1 c WHERE c.stateId = :stateId"),
    @NamedQuery(name = "CaproErpStates_1.findByStateCode", query = "SELECT c FROM CaproErpStates_1 c WHERE c.stateCode = :stateCode"),
    @NamedQuery(name = "CaproErpStates_1.findByStateName", query = "SELECT c FROM CaproErpStates_1 c WHERE c.stateName = :stateName"),
    @NamedQuery(name = "CaproErpStates_1.findByStateNameLocal", query = "SELECT c FROM CaproErpStates_1 c WHERE c.stateNameLocal = :stateNameLocal"),
    @NamedQuery(name = "CaproErpStates_1.findByCountryId", query = "SELECT c FROM CaproErpStates_1 c WHERE c.countryId = :countryId"),
    @NamedQuery(name = "CaproErpStates_1.findByStateStatus", query = "SELECT c FROM CaproErpStates_1 c WHERE c.stateStatus = :stateStatus"),
    @NamedQuery(name = "CaproErpStates_1.findByAddedUserId", query = "SELECT c FROM CaproErpStates_1 c WHERE c.addedUserId = :addedUserId"),
    @NamedQuery(name = "CaproErpStates_1.findByUpdatedUserId", query = "SELECT c FROM CaproErpStates_1 c WHERE c.updatedUserId = :updatedUserId"),
    @NamedQuery(name = "CaproErpStates_1.findByAddedIpAddress", query = "SELECT c FROM CaproErpStates_1 c WHERE c.addedIpAddress = :addedIpAddress"),
    @NamedQuery(name = "CaproErpStates_1.findByAddedLatitude", query = "SELECT c FROM CaproErpStates_1 c WHERE c.addedLatitude = :addedLatitude"),
    @NamedQuery(name = "CaproErpStates_1.findByAddedLongitude", query = "SELECT c FROM CaproErpStates_1 c WHERE c.addedLongitude = :addedLongitude"),
    @NamedQuery(name = "CaproErpStates_1.findByAddedDateTime", query = "SELECT c FROM CaproErpStates_1 c WHERE c.addedDateTime = :addedDateTime"),
    @NamedQuery(name = "CaproErpStates_1.findByUpdatedIpAddress", query = "SELECT c FROM CaproErpStates_1 c WHERE c.updatedIpAddress = :updatedIpAddress"),
    @NamedQuery(name = "CaproErpStates_1.findByUpdatedLatitude", query = "SELECT c FROM CaproErpStates_1 c WHERE c.updatedLatitude = :updatedLatitude"),
    @NamedQuery(name = "CaproErpStates_1.findByUpdatedLongitude", query = "SELECT c FROM CaproErpStates_1 c WHERE c.updatedLongitude = :updatedLongitude"),
    @NamedQuery(name = "CaproErpStates_1.findByUpdatedDateTime", query = "SELECT c FROM CaproErpStates_1 c WHERE c.updatedDateTime = :updatedDateTime")})
public class CaproErpStates_1 implements Serializable {
    ...
    public CaproErpStates_1() {
    }

    public CaproErpStates_1(Integer stateId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CaproErpStates_1)) {
            return false;
        }
        CaproErpStates_1 other = (CaproErpStates_1) object;
    ...
    public String toString() {
        return "com.caproerp.model.CaproErpStates_1[ stateId=" + stateId + " ]";
    }
