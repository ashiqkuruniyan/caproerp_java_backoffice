...
@NamedQueries({
    @NamedQuery(name = "CaproErpAdmin.findAll", query = "SELECT c FROM CaproErpAdmin c"),
    @NamedQuery(name = "CaproErpAdmin.findByAdminId", query = "SELECT c FROM CaproErpAdmin c WHERE c.adminId = :adminId"),
    @NamedQuery(name = "CaproErpAdmin.findByAdminCode", query = "SELECT c FROM CaproErpAdmin c WHERE c.adminCode = :adminCode"),
    @NamedQuery(name = "CaproErpAdmin.findByAdminName", query = "SELECT c FROM CaproErpAdmin c WHERE c.adminName = :adminName"),
    @NamedQuery(name = "CaproErpAdmin.findByAdminNameLocal", query = "SELECT c FROM CaproErpAdmin c WHERE c.adminNameLocal = :adminNameLocal"),
    @NamedQuery(name = "CaproErpAdmin.findByAdminContactNo", query = "SELECT c FROM CaproErpAdmin c WHERE c.adminContactNo = :adminContactNo"),
    @NamedQuery(name = "CaproErpAdmin.findByAdminWhatsappNo", query = "SELECT c FROM CaproErpAdmin c WHERE c.adminWhatsappNo = :adminWhatsappNo"),
    @NamedQuery(name = "CaproErpAdmin.findByAdminEmail", query = "SELECT c FROM CaproErpAdmin c WHERE c.adminEmail = :adminEmail"),
    @NamedQuery(name = "CaproErpAdmin.findByAdminLocation", query = "SELECT c FROM CaproErpAdmin c WHERE c.adminLocation = :adminLocation"),
    @NamedQuery(name = "CaproErpAdmin.findByAdminLocationLocal", query = "SELECT c FROM CaproErpAdmin c WHERE c.adminLocationLocal = :adminLocationLocal"),
    @NamedQuery(name = "CaproErpAdmin.findByAdminLatitude", query = "SELECT c FROM CaproErpAdmin c WHERE c.adminLatitude = :adminLatitude"),
    @NamedQuery(name = "CaproErpAdmin.findByAdminLongitude", query = "SELECT c FROM CaproErpAdmin c WHERE c.adminLongitude = :adminLongitude"),
    @NamedQuery(name = "CaproErpAdmin.findByCountryName", query = "SELECT c FROM CaproErpAdmin c WHERE c.countryName = :countryName"),
    @NamedQuery(name = "CaproErpAdmin.findByStateName", query = "SELECT c FROM CaproErpAdmin c WHERE c.stateName = :stateName"),
    @NamedQuery(name = "CaproErpAdmin.findByAdminAddress", query = "SELECT c FROM CaproErpAdmin c WHERE c.adminAddress = :adminAddress"),
    @NamedQuery(name = "CaproErpAdmin.findByCustomerCareName", query = "SELECT c FROM CaproErpAdmin c WHERE c.customerCareName = :customerCareName"),
    @NamedQuery(name = "CaproErpAdmin.findByCustomerCareNumber", query = "SELECT c FROM CaproErpAdmin c WHERE c.customerCareNumber = :customerCareNumber"),
    @NamedQuery(name = "CaproErpAdmin.findByCustomerCareEmail", query = "SELECT c FROM CaproErpAdmin c WHERE c.customerCareEmail = :customerCareEmail"),
    @NamedQuery(name = "CaproErpAdmin.findByAdminStatus", query = "SELECT c FROM CaproErpAdmin c WHERE c.adminStatus = :adminStatus"),
    @NamedQuery(name = "CaproErpAdmin.findByAddedUserId", query = "SELECT c FROM CaproErpAdmin c WHERE c.addedUserId = :addedUserId"),
    @NamedQuery(name = "CaproErpAdmin.findByUpdatedUserId", query = "SELECT c FROM CaproErpAdmin c WHERE c.updatedUserId = :updatedUserId"),
    @NamedQuery(name = "CaproErpAdmin.findByKeywords", query = "SELECT c FROM CaproErpAdmin c WHERE c.keywords = :keywords"),
    @NamedQuery(name = "CaproErpAdmin.findByAddedIpAddress", query = "SELECT c FROM CaproErpAdmin c WHERE c.addedIpAddress = :addedIpAddress"),
    @NamedQuery(name = "CaproErpAdmin.findByAddedLatitude", query = "SELECT c FROM CaproErpAdmin c WHERE c.addedLatitude = :addedLatitude"),
    @NamedQuery(name = "CaproErpAdmin.findByAddedLongitude", query = "SELECT c FROM CaproErpAdmin c WHERE c.addedLongitude = :addedLongitude"),
    @NamedQuery(name = "CaproErpAdmin.findByAddedDateTime", query = "SELECT c FROM CaproErpAdmin c WHERE c.addedDateTime = :addedDateTime"),
    @NamedQuery(name = "CaproErpAdmin.findByUpdatedIpAddress", query = "SELECT c FROM CaproErpAdmin c WHERE c.updatedIpAddress = :updatedIpAddress"),
    @NamedQuery(name = "CaproErpAdmin.findByUpdatedLatitude", query = "SELECT c FROM CaproErpAdmin c WHERE c.updatedLatitude = :updatedLatitude"),
    @NamedQuery(name = "CaproErpAdmin.findByUpdatedLongitude", query = "SELECT c FROM CaproErpAdmin c WHERE c.updatedLongitude = :updatedLongitude"),
    @NamedQuery(name = "CaproErpAdmin.findByUpdatedDateTime", query = "SELECT c FROM CaproErpAdmin c WHERE c.updatedDateTime = :updatedDateTime")})
public class CaproErpAdmin implements Serializable {
    ...
    public CaproErpAdmin() {
    }

    public CaproErpAdmin(Integer adminId) {
        this.adminId = adminId;
    }

    public CaproErpAdmin(Integer adminId, int adminStatus) {
        this.adminId = adminId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CaproErpAdmin)) {
            return false;
        }
        CaproErpAdmin other = (CaproErpAdmin) object;
    ...
    public String toString() {
        return "com.caproerp.products.model.CaproErpAdmin[ adminId=" + adminId + " ]";
    }
