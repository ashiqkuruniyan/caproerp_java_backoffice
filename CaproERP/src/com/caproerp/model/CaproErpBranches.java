...
@NamedQueries({
    @NamedQuery(name = "CaproErpBranches.findAll", query = "SELECT c FROM CaproErpBranches c"),
    @NamedQuery(name = "CaproErpBranches.findByBranchId", query = "SELECT c FROM CaproErpBranches c WHERE c.branchId = :branchId"),
    @NamedQuery(name = "CaproErpBranches.findByBranchCode", query = "SELECT c FROM CaproErpBranches c WHERE c.branchCode = :branchCode"),
    @NamedQuery(name = "CaproErpBranches.findByBranchName", query = "SELECT c FROM CaproErpBranches c WHERE c.branchName = :branchName"),
    @NamedQuery(name = "CaproErpBranches.findByBranchNameLocal", query = "SELECT c FROM CaproErpBranches c WHERE c.branchNameLocal = :branchNameLocal"),
    @NamedQuery(name = "CaproErpBranches.findByBranchContactPerson", query = "SELECT c FROM CaproErpBranches c WHERE c.branchContactPerson = :branchContactPerson"),
    @NamedQuery(name = "CaproErpBranches.findByBranchContactPersonLocal", query = "SELECT c FROM CaproErpBranches c WHERE c.branchContactPersonLocal = :branchContactPersonLocal"),
    @NamedQuery(name = "CaproErpBranches.findByBranchContactNo", query = "SELECT c FROM CaproErpBranches c WHERE c.branchContactNo = :branchContactNo"),
    @NamedQuery(name = "CaproErpBranches.findByBranchWhatsappNo", query = "SELECT c FROM CaproErpBranches c WHERE c.branchWhatsappNo = :branchWhatsappNo"),
    @NamedQuery(name = "CaproErpBranches.findByBranchCaption", query = "SELECT c FROM CaproErpBranches c WHERE c.branchCaption = :branchCaption"),
    @NamedQuery(name = "CaproErpBranches.findByBranchCaptionLocal", query = "SELECT c FROM CaproErpBranches c WHERE c.branchCaptionLocal = :branchCaptionLocal"),
    @NamedQuery(name = "CaproErpBranches.findByBranchLocation", query = "SELECT c FROM CaproErpBranches c WHERE c.branchLocation = :branchLocation"),
    @NamedQuery(name = "CaproErpBranches.findByBranchLocationLocal", query = "SELECT c FROM CaproErpBranches c WHERE c.branchLocationLocal = :branchLocationLocal"),
    @NamedQuery(name = "CaproErpBranches.findByBranchLatitude", query = "SELECT c FROM CaproErpBranches c WHERE c.branchLatitude = :branchLatitude"),
    @NamedQuery(name = "CaproErpBranches.findByBranchLongitude", query = "SELECT c FROM CaproErpBranches c WHERE c.branchLongitude = :branchLongitude"),
    @NamedQuery(name = "CaproErpBranches.findByBranchLaunchDate", query = "SELECT c FROM CaproErpBranches c WHERE c.branchLaunchDate = :branchLaunchDate"),
    @NamedQuery(name = "CaproErpBranches.findByBranchExpireDate", query = "SELECT c FROM CaproErpBranches c WHERE c.branchExpireDate = :branchExpireDate"),
    @NamedQuery(name = "CaproErpBranches.findByBranchGstIn", query = "SELECT c FROM CaproErpBranches c WHERE c.branchGstIn = :branchGstIn"),
    @NamedQuery(name = "CaproErpBranches.findByBranchTaxPercentage", query = "SELECT c FROM CaproErpBranches c WHERE c.branchTaxPercentage = :branchTaxPercentage"),
    @NamedQuery(name = "CaproErpBranches.findByBranchLicenseNo", query = "SELECT c FROM CaproErpBranches c WHERE c.branchLicenseNo = :branchLicenseNo"),
    @NamedQuery(name = "CaproErpBranches.findByBranchLogo", query = "SELECT c FROM CaproErpBranches c WHERE c.branchLogo = :branchLogo"),
    @NamedQuery(name = "CaproErpBranches.findByLetterHeadUrl", query = "SELECT c FROM CaproErpBranches c WHERE c.letterHeadUrl = :letterHeadUrl"),
    @NamedQuery(name = "CaproErpBranches.findByDomain", query = "SELECT c FROM CaproErpBranches c WHERE c.domain = :domain"),
    @NamedQuery(name = "CaproErpBranches.findByWebsiteUrl", query = "SELECT c FROM CaproErpBranches c WHERE c.websiteUrl = :websiteUrl"),
    @NamedQuery(name = "CaproErpBranches.findByNotificationAccess", query = "SELECT c FROM CaproErpBranches c WHERE c.notificationAccess = :notificationAccess"),
    @NamedQuery(name = "CaproErpBranches.findByLoginType", query = "SELECT c FROM CaproErpBranches c WHERE c.loginType = :loginType"),
    @NamedQuery(name = "CaproErpBranches.findByInvoiceNoType", query = "SELECT c FROM CaproErpBranches c WHERE c.invoiceNoType = :invoiceNoType"),
    @NamedQuery(name = "CaproErpBranches.findByCountryName", query = "SELECT c FROM CaproErpBranches c WHERE c.countryName = :countryName"),
    @NamedQuery(name = "CaproErpBranches.findByStateName", query = "SELECT c FROM CaproErpBranches c WHERE c.stateName = :stateName"),
    @NamedQuery(name = "CaproErpBranches.findByBranchEmail", query = "SELECT c FROM CaproErpBranches c WHERE c.branchEmail = :branchEmail"),
    @NamedQuery(name = "CaproErpBranches.findByBranchAddress", query = "SELECT c FROM CaproErpBranches c WHERE c.branchAddress = :branchAddress"),
    @NamedQuery(name = "CaproErpBranches.findByBuildingNo", query = "SELECT c FROM CaproErpBranches c WHERE c.buildingNo = :buildingNo"),
    @NamedQuery(name = "CaproErpBranches.findByStreet", query = "SELECT c FROM CaproErpBranches c WHERE c.street = :street"),
    @NamedQuery(name = "CaproErpBranches.findByStreetLocal", query = "SELECT c FROM CaproErpBranches c WHERE c.streetLocal = :streetLocal"),
    @NamedQuery(name = "CaproErpBranches.findByAdditionalNo", query = "SELECT c FROM CaproErpBranches c WHERE c.additionalNo = :additionalNo"),
    @NamedQuery(name = "CaproErpBranches.findByDistrictName", query = "SELECT c FROM CaproErpBranches c WHERE c.districtName = :districtName"),
    @NamedQuery(name = "CaproErpBranches.findByDistrictNameLocal", query = "SELECT c FROM CaproErpBranches c WHERE c.districtNameLocal = :districtNameLocal"),
    @NamedQuery(name = "CaproErpBranches.findByZipCode", query = "SELECT c FROM CaproErpBranches c WHERE c.zipCode = :zipCode"),
    @NamedQuery(name = "CaproErpBranches.findByCityName", query = "SELECT c FROM CaproErpBranches c WHERE c.cityName = :cityName"),
    @NamedQuery(name = "CaproErpBranches.findByCityNameLocal", query = "SELECT c FROM CaproErpBranches c WHERE c.cityNameLocal = :cityNameLocal"),
    @NamedQuery(name = "CaproErpBranches.findByBranchWorkStartTime", query = "SELECT c FROM CaproErpBranches c WHERE c.branchWorkStartTime = :branchWorkStartTime"),
    @NamedQuery(name = "CaproErpBranches.findByBranchWorkEndTime", query = "SELECT c FROM CaproErpBranches c WHERE c.branchWorkEndTime = :branchWorkEndTime"),
    @NamedQuery(name = "CaproErpBranches.findByBranchStatus", query = "SELECT c FROM CaproErpBranches c WHERE c.branchStatus = :branchStatus"),
    @NamedQuery(name = "CaproErpBranches.findByAddedUserId", query = "SELECT c FROM CaproErpBranches c WHERE c.addedUserId = :addedUserId"),
    @NamedQuery(name = "CaproErpBranches.findByKeywords", query = "SELECT c FROM CaproErpBranches c WHERE c.keywords = :keywords"),
    @NamedQuery(name = "CaproErpBranches.findByUpdatedUserId", query = "SELECT c FROM CaproErpBranches c WHERE c.updatedUserId = :updatedUserId"),
    @NamedQuery(name = "CaproErpBranches.findByAddedIpAddress", query = "SELECT c FROM CaproErpBranches c WHERE c.addedIpAddress = :addedIpAddress"),
    @NamedQuery(name = "CaproErpBranches.findByAddedLatitude", query = "SELECT c FROM CaproErpBranches c WHERE c.addedLatitude = :addedLatitude"),
    @NamedQuery(name = "CaproErpBranches.findByAddedLongitude", query = "SELECT c FROM CaproErpBranches c WHERE c.addedLongitude = :addedLongitude"),
    @NamedQuery(name = "CaproErpBranches.findByAddedDateTime", query = "SELECT c FROM CaproErpBranches c WHERE c.addedDateTime = :addedDateTime"),
    @NamedQuery(name = "CaproErpBranches.findByUpdatedIpAddress", query = "SELECT c FROM CaproErpBranches c WHERE c.updatedIpAddress = :updatedIpAddress"),
    @NamedQuery(name = "CaproErpBranches.findByUpdatedLatitude", query = "SELECT c FROM CaproErpBranches c WHERE c.updatedLatitude = :updatedLatitude"),
    @NamedQuery(name = "CaproErpBranches.findByUpdatedLongitude", query = "SELECT c FROM CaproErpBranches c WHERE c.updatedLongitude = :updatedLongitude"),
    @NamedQuery(name = "CaproErpBranches.findByUpdatedDateTime", query = "SELECT c FROM CaproErpBranches c WHERE c.updatedDateTime = :updatedDateTime")})
public class CaproErpBranches implements Serializable {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "caproErpBranches")
    ...
    public CaproErpBranches() {
    }

    public CaproErpBranches(Integer branchId) {
        this.branchId = branchId;
    }

    public CaproErpBranches(Integer branchId, String domain) {
        this.branchId = branchId;
        this.domain = domain;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CaproErpBranches)) {
            return false;
        }
        CaproErpBranches other = (CaproErpBranches) object;
    ...
    public String toString() {
        return "com.caproerp.products.model.CaproErpBranches[ branchId=" + branchId + " ]";
    }
